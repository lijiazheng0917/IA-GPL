...
python prompt_tuning.py --model_file pretrained_models/edgepred.pth --dataset hiv --num_layers 4  --n_codebooks 20 --n_samples 10 --lr 0.005
python prompt_tuning.py --model_file pretrained_models/edgepred.pth --dataset muv --num_layers 2  --n_codebooks 20 --n_samples 10 --lr 0.0005
...
python prompt_tuning.py --model_file pretrained_models/edgepred.pth --dataset hiv --full_few few --num_layers 3 --n_codebooks 50 --n_samples 10 --lr 0.005 --split random
python prompt_tuning.py --model_file pretrained_models/edgepred.pth --dataset muv --full_few few --num_layers 2--n_codebooks 20 --n_samples 10 --lr 0.005 --split random
...
python prompt_tuning.py --model_file pretrained_models/edgepred.pth --dataset hiv --num_layers 2 --n_codebooks 20 --n_samples 10 --lr 0.001 --split random
python prompt_tuning.py --model_file pretrained_models/edgepred.pth --dataset muv --num_layers 2 --n_codebooks 20 --n_samples 10 --lr 0.0001 --split random